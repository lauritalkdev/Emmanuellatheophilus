...
export default function Testimonials() {
  return (
    <section id="results" className="bg-[#F7F4EF] text-[#0E0E0E] px-14 py-28">
      ...
      <h2 className="font-serif text-6xl font-light leading-tight mb-16">What happens when your story is <span className="italic text-[#B8924A]">finally told well.</span></h2>
      <div className="grid grid-cols-3 gap-5">
        {testimonials.map((t) => (
          <div key={t.name} className={`bg-[#EDE9E1] border border-[#B8924A]/15 hover:border-[#B8924A] rounded-sm p-8 transition-all duration-300 hover:-translate-y-1 ${t.wide ? "col-span-2" : "col-span-1"}`}>
