export default function About() {
  return (
    <section id="about" className="bg-[#F7F4EF] text-[#0E0E0E] px-14 py-28">
      ...
      <h2 className="font-serif text-6xl font-light leading-tight mb-16">Built for the people who are good <span className="italic text-[#B8924A]">and still invisible.</span></h2>
      <div className="grid grid-cols-2 gap-20">
        ...
        <div>
          <blockquote className="font-serif text-2xl font-light italic text-[#0E0E0E] border-l-2 border-[#B8924A] pl-6 mb-8">There is a kind of frustration that comes from knowing you are good at what you do, and watching less experienced people get the recognition you deserve.</blockquote>
