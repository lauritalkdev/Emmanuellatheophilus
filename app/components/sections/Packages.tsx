...
export default function Packages() {
  return (
    <section id="packages" className="bg-[#0E0E0E] text-[#F7F4EF] px-14 py-28 border-t border-[#B8924A]/20">
      ...
      <h2 className="font-serif text-6xl font-light leading-tight mb-16">Three levels of <span className="italic text-[#B8924A]">transformation.</span></h2>
      <div className="grid grid-cols-3 gap-6">
        {packages.map((p) => (
          <div key={p.name} className={`rounded-sm p-10 border transition-all duration-300 hover:-translate-y-1 ${p.featured ? "border-[#B8924A] bg-[#161614]" : "border-[#B8924A]/20 bg-[#161614] hover:border-[#B8924A]"}`}>
